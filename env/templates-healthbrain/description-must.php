...
<div class="description-must" style="position:relative; overflow:visible;">
        Did you mean to check out my <a target="_blank" href="../bizbrain">💼 tech startup business notes</a>?
    <div style="position:absolute; bottom:-30px; left:0; width:100%; text-align:center; line-height: 80%;color: rgba(125, 125, 125, 0.3); font-size: 80%;">
